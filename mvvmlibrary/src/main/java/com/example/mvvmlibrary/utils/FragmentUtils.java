...
public final class FragmentUtils {
    ...
    protected final <T extends View> T findView(Activity activity, int id) {
        try {
            return null != activity ? (T) activity.findViewById(id) : null;
    ...
    public static void removeFragment(@NonNull Fragment fragment) {
        ...
        if (fragmentManager != null) {
            operateFragment(fragmentManager, null, fragment, TYPE_REMOVE_FRAGMENT);
        }
    }
    ...
    public static void removeToFragment(@NonNull Fragment fragment, boolean isIncludeSelf) {
        FragmentManager fragmentManager = fragment.getFragmentManager();
        if (fragmentManager != null) {
            operateFragment(fragmentManager, isIncludeSelf ? fragment : null, fragment, TYPE_REMOVE_TO_FRAGMENT);
        }
    }
    ...
    public static Fragment replaceFragment(@NonNull Fragment srcFragment,
        ...
        if (fragmentManager != null) {
            return replaceFragment(fragmentManager, destFragment, containerId, isAddStack);
        }
        return null;
    }
    ...
    public static Fragment replaceFragment(@NonNull Fragment srcFragment,
        ...
        FragmentManager fragmentManager = srcFragment.getFragmentManager();
        if (fragmentManager != null) {
            return replaceFragment(fragmentManager, destFragment, containerId, isAddStack, sharedElement);
        }
        return null;
    }
    ...
    /**
     * Fragment切换,并获取当前显示及上一显示的Fragment
     *
     * @param fragmentManager fragment管理器
     * @param fromFragment    fragment
     * @param toFragment      目的fragment
     * @param containerId     布局Id
     * @param args            参数
     */
    public static void switchFragment(FragmentManager fragmentManager, Fragment fromFragment, Fragment toFragment, @IdRes int containerId, Bundle args) {
        if (null != fragmentManager && null != fromFragment && null != toFragment) {
...
//            ft.setCustomAnimations(R.anim.slide_in_from_bottom, R.anim.slide_out_to_bottom, R.anim.slide_in_from_bottom, R.anim.slide_out_to_bottom);
            ...
            if (!toFragment.isAdded()) {
                ...
                ft.hide(fromFragment).add(containerId, toFragment);
            } else {
    ...
    public static Fragment hideFragment(@NonNull Fragment fragment) {
        ...
        FragmentManager fragmentManager = fragment.getFragmentManager();
        if (fragmentManager != null) {
            return operateFragment(fragmentManager, null, fragment, TYPE_HIDE_FRAGMENT);
        }
        return null;
    }
    ...
    public static Fragment hideShowFragment(@NonNull Fragment hideFragment,
        ...
        if (fragmentManager != null) {
            return operateFragment(fragmentManager, hideFragment, showFragment, TYPE_HIDE_SHOW_FRAGMENT);
        }
        return null;
    }
     ...
     * @return 显示的Fragment
     */
    public static Fragment hideAndShowFragment(@NonNull FragmentManager fragmentManager,
                                               @NonNull Fragment hideFragment,
                                               @NonNull Fragment showFragment) {
        Args args = getArgs(hideFragment);
        if (args != null) {
            putArgs(hideFragment, new Args(args.id, true, true));
            putArgs(showFragment, new Args(args.id, false, true));
            LogUtil.d("args.id:" + args.id + ",FragmentManager:" + (showFragment.getFragmentManager() == null));
        }
        return operateFragment(fragmentManager, hideFragment, showFragment, TYPE_HIDE_SHOW_FRAGMENT);
    }
    ...
    public static boolean dispatchBackPress(@NonNull Fragment fragment) {
        FragmentManager fragmentManager = fragment.getFragmentManager();
        return fragmentManager != null && dispatchBackPress(fragmentManager);
    }
     ...
     * @return true/false
     */
    public static boolean isBackStackEmpty(@NonNull FragmentManager fragmentManager) {
    ...
    static class FragmentNode {
        ...
        FragmentNode(Fragment fragment, List<FragmentNode> next) {
    ...
    /**
     * 物理Back键,Fragment不处理,则由Activity处理
     */
